...
if command -v zip >/dev/null 2>&1; then
  ...
  if [ -d "$ROOT_DIR/docs" ]; then
    ...
    cp "$ROOT_DIR/userscript/yayi.user.js" "$ROOT_DIR/docs/downloads/yayi.user.js"
